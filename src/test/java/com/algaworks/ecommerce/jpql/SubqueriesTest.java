...
public class SubqueriesTest extends EntityManagerTest {
    ...
    public void pesquisarComAny() {
        //Compara um valor escalar com um conjunto de valores de uma única coluna. Para obter mais informações
...
//                " where p.preco = ANY (select precoProduto from ItemPedido where produto = p)";
    ...
    public void pesquisarComAll() {
        //ALL - Compara um valor escalar com um conjunto de valores de uma única coluna.
